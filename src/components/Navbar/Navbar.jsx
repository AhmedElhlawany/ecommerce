    ...
    <>
      ...
      <nav className=" border-gray-200 dark:bg-gray-900 w-full  border rounded-b-lg bg-emerald-300 fixed z-50">
        <div className="w-11/12  flex  md:flex-row items-center px-2  mx-auto p-4">
          ...
          <button data-collapse-toggle="navbar-default" type="button" className="mb-auto ms-auto inline-flex items-center m-6 p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
